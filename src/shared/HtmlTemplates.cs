...
public class HtmlTemplates
{
    ...
    public static string ViewAllGet(List<User> users, int userCount, int page, int size)
    {
    ...
    public static string AddGet(string username, string role)
    {
        string roles = "";
    ...
    public static string ViewGet(User user)
    {
        string html = $@"
                <table class=""view"">
                    <thead>
    ...
    public static string EditGet(User user, int uid)
    {
           string roles = "";
